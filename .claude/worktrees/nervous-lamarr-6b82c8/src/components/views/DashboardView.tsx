...
const SKU_COLORS: Record<string, string> = {
  ...
  exports: '#0ea5e9',
  // ReSpark — Maintenance
  maintenance_essentials: '#8b5cf6',
  maintenance_pro: '#7c3aed',
  maintenance_enterprise: '#6d28d9',
}
const ADDON_LABELS: Record<string, string> = {
  ...
  api: 'API',
  // ReSpark — Pro Add-Ons
  commercial_agent: 'Commercial Agent (AI)',
  operations_agent: 'Operations Agent (AI)',
  finance_agent: 'Finance Agent (AI)',
  dispatch_agent: 'Dispatch Agent (AI)',
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {step === 2 && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div style={{ fontSize: 12, color: 'var(--text)', marginBottom: 8 }}>SKU</div>
            <div style={{ fontSize: 10, fontWeight: 600, color: 'var(--text-3)', marginBottom: 4, letterSpacing: '0.05em' }}>YARD OPS</div>
            <div style={{ display: 'flex', gap: 8, marginBottom: 8 }}>
              {[['essentials', 'Essentials'], ['pro', 'Pro']].map(([val, label]) => (
            ...
            <div style={{ fontSize: 10, fontWeight: 600, color: 'var(--text-3)', marginBottom: 4, letterSpacing: '0.05em' }}>LOGISTICS</div>
            <div style={{ display: 'flex', gap: 8, marginBottom: 8 }}>
              {[['dispatch', 'Dispatch'], ['dispatch_pro', 'Dispatch Pro'], ['rail', 'Rail'], ['exports', 'Exports']].map(([val, label]) => (
                <button key={val} onClick={() => { setSku(val); setSelectedPlanId(null) }} style={{
                  flex: 1, padding: '8px 0', borderRadius: 6,
                  background: sku === val ? SKU_COLORS[val] + '22' : 'var(--bg-surface2)',
                  border: `1px solid ${sku === val ? SKU_COLORS[val] : 'var(--border-b)'}`,
            ...
            <div style={{ fontSize: 10, fontWeight: 600, color: 'var(--text-3)', marginBottom: 4, letterSpacing: '0.05em' }}>MAINTENANCE</div>
            <div style={{ display: 'flex', gap: 8, marginBottom: 4 }}>
              {[['maintenance_essentials', 'Maint. Essentials'], ['maintenance_pro', 'Maint. Pro'], ['maintenance_enterprise', 'Maint. Enterprise']].map(([val, label]) => (
                <button key={val} onClick={() => { setSku(val); setSelectedPlanId(null) }} style={{
                  flex: 1, padding: '8px 0', borderRadius: 6,
                  background: sku === val ? SKU_COLORS[val] + '22' : 'var(--bg-surface2)',
                  border: `1px solid ${sku === val ? SKU_COLORS[val] : 'var(--border-b)'}`,
            ...
            <div style={{ fontSize: 12, color: 'var(--text)', marginTop: 8, marginBottom: 8 }}>Add-ons</div>
