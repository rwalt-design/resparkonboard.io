...
export const CHANGELOG: ChangelogEntry[] = [
  {
    date: '2026-05-14',
    title: 'Sub-items in plan templates, archive fix, and SKU updates',
    bullets: [
      'You can now add sub-items to task items directly in the plan template builder — type and press Enter to add, click × to remove',
      'Sub-items defined in a template are automatically carried over when the plan is applied to an account',
      'Fixed a bug where archiving a plan template would briefly remove it then restore it due to a stale data refresh',
      'Plan template SKU picker now shows all ReSpark SKUs',
    ],
  },
  {
    date: '2026-05-14',
    title: 'Updated product SKUs to match the ReSpark lineup',
    bullets: [
      'New account SKUs now reflect ReSpark products — Essentials, Pro, Dispatch, Dispatch Pro, Rail, Exports, and three Maintenance tiers',
      'Add-ons updated to include the ReSpark Pro Add-Ons: Commercial Agent, Operations Agent, Finance Agent, Dispatch Agent, Supplier Portal, Integrated GL, Brokerage, and CRV Processing',
      'Existing accounts are unaffected — legacy SKUs still display correctly',
    ],
  },
  {
    date: '2026-05-13',
