export type Sku =
  // Legacy (ReMatter)
  | 'facility_management' | 'full_suite'
  // ReSpark — Yard Ops
  | 'essentials' | 'pro'
  // ReSpark — Logistics
  | 'dispatch' | 'dispatch_pro' | 'rail' | 'exports'
  // ReSpark — Maintenance
  | 'maintenance_essentials' | 'maintenance_pro' | 'maintenance_enterprise'

export type Addon =
  // Legacy (ReMatter)
  | 'brokerage' | 'export' | 'api'
  // ReSpark — Pro Add-Ons
  | 'commercial_agent' | 'operations_agent' | 'finance_agent' | 'dispatch_agent'
  | 'supplier_portal' | 'integrated_gl' | 'crv'
  // ReSpark — Logistics (as add-on)
  | 'dispatch' | 'dispatch_pro' | 'rail' | 'exports'
  // ReSpark — Maintenance (as add-on)
  | 'maintenance_essentials' | 'maintenance_pro' | 'maintenance_enterprise'
