...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    bullets: [
      ...
      'The exported onboarding plan now shows the Go-Live target date on the cover and lists every step in the plan — with customer tasks clearly marked "Yours" and Respark tasks labeled accordingly',
