...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Stages owned entirely by the customer (User Testing, Post Launch) show a Customer badge on the stage header',
      'A Go-Live marker with the target date appears between the Launch and Post Launch stages',
      'Removed the text input boxes — replaced with a one-line note to write down questions for the upcoming session',
      'Additional items filtered from exports: Update OB Plan, Review Pre-Launch Checklist, Outstanding Item Cleanup',
      'Footer now reads "Generated by ReSpark" instead of "Generated by ReSpark Onboard"',
    ],
  },
  {
    date: '2026-05-15',
