...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    bullets: [
      'Clicking "Export Plan" now opens a selection panel where you can check or uncheck exactly which items go in the PDF before downloading — your choices are saved per account',
      'PDF downloads directly — no browser print dialog, no URLs or timestamps bleeding in',
      'The PDF has a cover page (client name, go-live date, your contact info), then three sections: onboarding plan, hardware checklist, and reporting & compliance',
      'Every item shows who owns it — ReSpark, customer, or session — and a Go-Live marker with the target date appears at the right point in the plan',
      'ReSpark logo now shows correctly in the PDF — the old "onboard.io" branding is gone',
      'Three new tabs on every account — Hardware, Reporting, and Compliance — auto-populated when a client submits their intake form',
      'Hardware tab generates one checklist row per unit, Reporting shows every legacy report with space to fill in the ReMatter equivalent, Compliance lists every regulatory requirement they flagged — all editable inline',
      'SKU list updated to match the current product lineup: Essentials, Pro, Dispatch, Rail, Exports, UptimePM Core/Pro/Enterprise, and the matching add-ons',
      'Custom interaction logging now has an Internal option — shows in the timeline but doesn\'t affect Last Contact or Last Outreach numbers',
    ],
  },
  {
    date: '2026-05-13',
